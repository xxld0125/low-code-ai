...
// 单选框样式属性定义
const radioStyleProperties: StylePropertyDefinition[] = [
  // 单选框尺寸
  {
    id: 'radioSize',
    name: 'radioSize',
  ...
  // 边框属性
  {
    ...
    description: '单选框的边框样式',
    config: {
      allowRadius: false, // 单选框是圆形
      presets: [
...
// 样式分组定义
const radioStyleGroups: StyleGroup[] = [
  {
    id: 'layout',
    name: '布局',
    properties: radioStyleProperties.filter(prop => prop.category === 'layout'),
  },
  {
    id: 'spacing',
    name: '间距',
    properties: radioStyleProperties.filter(prop => prop.category === 'spacing'),
  },
  {
    id: 'typography',
    name: '字体',
    properties: radioStyleProperties.filter(prop => prop.category === 'typography'),
  },
  {
    id: 'colors',
    name: '颜色',
    properties: radioStyleProperties.filter(prop => prop.category === 'color'),
  },
  {
    id: 'border',
    name: '边框',
    properties: radioStyleProperties.filter(prop => prop.category === 'border'),
  },
  {
    id: 'effects',
    name: '效果',
    properties: radioStyleProperties.filter(prop => prop.category === 'shadow' || prop.category === 'effects'),
  },
]

// Radio组件样式定义
export const RadioStyleDefinition: ComponentStyleDefinition = {
  id: 'radio-style',
  name: 'Radio',
  category: 'basic',
  style_schema: {
    groups: radioStyleGroups,
  },
  properties: radioStyleProperties,
  defaultStyles: {
    radioSize: '16px',
    margin: '0',
    gap: '8px',
...
export default RadioStyleDefinition