                ...
                <div className="mt-3 space-y-3">
                  ...
                  {error.stack && (
                    <div className="rounded-lg border bg-orange-50 p-3">
                      ...
                      <pre className="text-xs text-orange-700 whitespace-pre-wrap font-mono max-h-32 overflow-auto">
                        {error.stack}
                      </pre>
                    </div>
                  )}
                  ...
                  {errorInfo?.componentStack && (
                    <div className="rounded-lg border bg-blue-50 p-3">
                      ...
                      <pre className="text-xs text-blue-700 whitespace-pre-wrap font-mono max-h-32 overflow-auto">
                        {errorInfo.componentStack}
                      </pre>
                    </div>
                  )}
